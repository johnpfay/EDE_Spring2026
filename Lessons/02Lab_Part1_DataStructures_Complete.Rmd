...
# Show the item labelled "age"
list1$age

# Show all the labels/names
names(list1)

# Show the first 2 items 
list1[1:2]

# Update the value associated with the label "name"
list1$name = "Janelle"

# Update the 4th item in the list
list1[[4]] = 44
```
