---
title: "8: Part 1 - Generalized Linear Models"
...
irradiance.regression <- 
  lm(PeterPaul.chem.nutrients$irradianceWater ~ PeterPaul.chem.nutrients$depth)
...
# Correlation - show the *strength* of the relationship (vs magnitude)
