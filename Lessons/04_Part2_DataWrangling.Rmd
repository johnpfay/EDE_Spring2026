...
```{r using rbind}
Litter.June2016 <- read.csv(here("Data/Raw/NIWO_Litter/NEON_NIWO_Litter_massdata_2016-06_raw.csv"))
Litter.July2016 <- read.csv(here("Data/Raw/NIWO_Litter/NEON_NIWO_Litter_massdata_2016-07_raw.csv"))
Litter.August2016 <- read.csv(here("Data/Raw/NIWO_Litter/NEON_NIWO_Litter_massdata_2016-08_raw.csv"))
...
LitterFiles = list.files(path = here("Data/Raw/NIWO_Litter/"), pattern="*.csv", full.names=TRUE)
LitterFiles
...
Trap <- read.csv(here("Data/Raw/NEON_NIWO_Litter_trapdata_raw.csv"))
